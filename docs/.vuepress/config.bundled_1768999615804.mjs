...
var init_fr = __esm({
  "docs/.vuepress/config/nav/fr.ts"() {
    frNavbar = [
      ...
      { text: "\xC0 propos", link: "/fr/apropos/", ariaLabel: "\xC0 propos - Dotfiles" }
    ];
  }
});
    ...
    module.exports = {
      ...
      locales: {
        "/": {
          lang: "en-GB",
          title: "Dotfiles",
          description: "The next generation of Bash configuration files for macOS, Linux and Windows. Featuring a Modern Core (Atuin, Yazi, Zellij) and Native SSH Security."
        },
        "/fr/": {
          lang: "fr-FR",
          title: "Les Dotfiles",
          description: "La prochaine g\xE9n\xE9ration de fichiers de configuration Bash pour macOS, Linux et Windows. Avec un Noyau Moderne (Atuin, Yazi, Zellij) et S\xE9curit\xE9 SSH Native."
        }
      },
      evergreen: true,
      head: headers,
