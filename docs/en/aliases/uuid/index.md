---
title: UUID Aliases | Dotfiles
description: Generate UUIDs with aliases in Dotfiles v0.2.495. Short commands for v4 UUID creation and clipboard integration on macOS, Linux, and WSL.
lang: en-GB
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: UUID Aliases | Dotfiles preview
canonical: /en/aliases/uuid/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: UUID Aliases
pageType: docs
schemaType: WebPage
permalink: /en/aliases/uuid/
---
...
- [UUID Reference Appendix](./reference.md)
