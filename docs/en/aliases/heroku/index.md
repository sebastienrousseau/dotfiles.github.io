---
title: Heroku Aliases | Dotfiles
description: Explore Heroku aliases in Dotfiles v0.2.495. Concise commands for app deployment, scaling, and log management on macOS, Linux, and WSL.
lang: en-GB
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: Heroku Aliases | Dotfiles preview
canonical: /en/aliases/heroku/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Heroku Aliases
pageType: docs
schemaType: WebPage
permalink: /en/aliases/heroku/
---

# Heroku Aliases

Short Heroku commands.
...
- [Heroku Reference Appendix](./reference.md)
