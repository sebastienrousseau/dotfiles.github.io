---
title: Subversion Reference Appendix | Dotfiles
description: Complete alias and helper function reference for Subversion in Dotfiles v0.2.495. Includes every shortcut, usage example, and shell function for macOS, Linux, and WSL.
lang: en-GB
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: Subversion Reference Appendix | Dotfiles preview
canonical: /en/aliases/subversion/reference/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Subversion Reference
pageType: docs
schemaType: WebPage
permalink: /en/aliases/subversion/reference/
---

# Subversion Reference Appendix

## Source files

- `.chezmoitemplates/aliases/subversion/subversion.aliases.sh`
- `.chezmoitemplates/aliases/subversion/svn.aliases.sh`
...
| `slg` | `'svn log'        # slg: Show the log messages for a set of revision(s) and/or path(s).` |
| `slk` | `'svn lock'       # slock: Lock working copy paths or URLs in the repository, so that no other user can commit changes to them.` |
| `slk` | `'svn lock'       # slock: Lock working copy paths or URLs in the repository, so that no other user can commit changes to them.` |
