...
description: Explore diagnostics aliases in Dotfiles v0.2.495. Quick health check commands for system, network, and service monitoring on macOS, Linux, and WSL.
lang: en-GB
