...
lastUpdated: true
image: /logo.png
imageAlt: Archives Aliases | Dotfiles preview
canonical: /en/aliases/archives/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Archives Aliases
pageType: docs
schemaType: WebPage
permalink: /en/aliases/archives/
---
...
- [Archives Reference Appendix](./reference.md)
