...
lastUpdated: true
image: /logo.png
imageAlt: "Aliases de Find: Busca de Arquivos com fd preview"
canonical: /pt/aliases/find/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "Aliases de Find: Busca de Arquivos com fd"
pageType: docs
schemaType: WebPage
...
Estes aliases são definidos em `find.aliases.sh` e carregados automaticamente pelo Chezmoi. Eles utilizam `fd`, uma ferramenta simples, rapida e amigavel para buscar arquivos e diretorios.

## Referência

| Alias | Descrição |
|-------|-------------|
| `fd` | Alias padrão para `fd --color always`, lista com cores |
