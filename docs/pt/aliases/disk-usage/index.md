...
lastUpdated: true
image: /logo.png
imageAlt: "Aliases de Uso de Disco: Analise de Armazenamento preview"
canonical: /pt/aliases/disk-usage/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "Aliases de Uso de Disco: Analise de Armazenamento"
pageType: docs
schemaType: WebPage
...
Estes aliases são definidos em `disk-usage.aliases.sh` e carregados automaticamente pelo Chezmoi.
