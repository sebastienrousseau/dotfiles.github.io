...
lastUpdated: true
image: /logo.png
imageAlt: "Aliases de Update: Atualizacao do Sistema e Software preview"
canonical: /pt/aliases/update/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "Aliases de Update: Atualizacao do Sistema e Software"
pageType: docs
schemaType: WebPage
...
Estes aliases são definidos em `update.aliases.sh` e carregados automaticamente pelo Chezmoi.
