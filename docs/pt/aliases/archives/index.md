---
title: Aliases de Arquivos | Dotfiles
description: Aliases de arquivamento e compactação para manipular tar, zip, 7z e mais. Extrair, compactar e gerenciar arquivos com comandos simples.
lang: pt-BR
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: Aliases de Arquivos preview
canonical: /pt/aliases/archives/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Aliases de Arquivos
pageType: docs
schemaType: WebPage
...
meta:
  - name: keywords
    content: arquivos, compactação, tar, zip, 7z, gzip, extrair, aliases shell, dotfiles
  - name: twitter:card
    content: summary
  - name: twitter:description
    content: Aliases de arquivamento e compactação para manipular tar, zip, 7z e mais. Extrair, compactar e gerenciar arquivos com comandos simples.
  - name: twitter:title
...
Estes aliases são definidos em `archives.aliases.sh` e carregados automaticamente pelo Chezmoi.
