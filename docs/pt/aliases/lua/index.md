...
lastUpdated: true
image: /logo.png
imageAlt: "Aliases Lua: Acesso rápido aos interpretadores Lua REPL preview"
canonical: /pt/aliases/lua/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "Aliases Lua: Acesso rápido aos interpretadores Lua REPL"
pageType: docs
schemaType: WebPage
