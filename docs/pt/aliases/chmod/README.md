...
lang: pt-BR
metaTitle: Chmod aliases - Dotfiles (BR)
...
meta:
  ...
  - name: twitter:description
    content: The Chmod aliases allow to change the permissions (or access mode) of a file or directory.
  - name: twitter:title
    content: Chmod aliases - Dotfiles (BR)
  - name: og:title
    content: Chmod aliases - Dotfiles (BR)
  - name: og:description
    content: The Chmod aliases allow to change the permissions (or access mode) of a file or directory.
...
| chgrp  | `chgrp -v`          | Change group ownership of arquivos or directories.                                                                                                                                                                      |
| chgrpr | `chgrp -Rv`         | Change group ownership of arquivos or directories recursively.                                                                                                                                                          |
| chgrpu | `chgrp -Rv ${USER}` | Change group ownership of arquivos or directories recursively to the current user.                                                                                                                                      |
| chmod  | `chmod -v`          | Change arquivo mode bits.                                                                                                                                                                                               |
| chmodr | `chmod -Rv`         | Change arquivo mode bits recursively.                                                                                                                                                                                   |
| chmodu | `chmod -Rv u+rwX`   | Change arquivo mode bits recursively to the current user.                                                                                                                                                               |
| chmox  | `chmod +x`          | Make a arquivo executable.                                                                                                                                                                                              |
| chown  | `chown -v`          | Change arquivo owner and group.                                                                                                                                                                                         |
| chownr | `chown -Rv`         | Change arquivo owner and group recursively.                                                                                                                                                                             |
| chownu | `chown -Rv ${USER}` | Change arquivo owner and group recursively to the current user.                                                                                                                                                         |
