...
lastUpdated: true
image: /logo.png
imageAlt: "Aliases de Subversion: Atalhos para SVN preview"
canonical: /pt/aliases/subversion/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "Aliases de Subversion: Atalhos para SVN"
pageType: docs
schemaType: WebPage
...
meta:
  - name: keywords
    content: aliases subversion, svn, controle versão, aliases shell, dotfiles
  - name: twitter:card
    content: summary
...
Atalhos para controle de versão com Subversion.

## Visão Geral

Estes aliases são definidos em `subversion.aliases.sh` e carregados automaticamente pelo Chezmoi.

## Referência

| Alias | Descrição |
|-------|-------------|
| `sad` | Adicionar arquivos/diretorios ao controle de versão |
...
| `sdl` | Remover arquivos/diretorios do controle de versão |
| `shp` | Mostrar uso do programa |
| `sin` | Mostrar informacao local/remota |
| `sip` | Commit de arquivo não versionado |
| `slg` | Mostrar logs |
...
| `sxp` | Criar copia não versionada |
