...
lastUpdated: true
image: /logo.png
imageAlt: "Aliases de NPM: Atalhos para o Gerenciador de Pacotes Node.js preview"
canonical: /pt/aliases/npm/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "Aliases de NPM: Atalhos para o Gerenciador de Pacotes Node.js"
pageType: docs
schemaType: WebPage
...
Estes aliases são definidos em `npm.aliases.sh` e carregados automaticamente pelo Chezmoi.
