...
lastUpdated: true
image: /logo.png
imageAlt: "Aliases de Rust: Atalhos para Cargo e Rustup preview"
canonical: /pt/aliases/rust/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "Aliases de Rust: Atalhos para Cargo e Rustup"
pageType: docs
schemaType: WebPage
...
Estes aliases são definidos em `rust.aliases.sh` e carregados automaticamente pelo Chezmoi.
