---
title: Funções | Dotfiles
description: Funções de shell fornecidas por Dotfiles para aprimorar sua experiência no terminal. Compatível com macOS, Linux e WSL via Dotfiles.
lang: pt-BR
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: Funções preview
canonical: /pt/functions/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Funções
pageType: docs
schemaType: WebPage
