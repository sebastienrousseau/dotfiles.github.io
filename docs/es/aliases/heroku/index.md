...
lastUpdated: true
image: /logo.png
imageAlt: "Alias Heroku: atajos shell para la CLI de Heroku preview"
canonical: /es/aliases/heroku/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "Alias Heroku: atajos shell para la CLI de Heroku"
pageType: docs
schemaType: WebPage
