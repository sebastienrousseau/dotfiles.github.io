...
lang: es-ES
metaTitle: Chmod aliases - Dotfiles (ES)
...
meta:
  ...
  - name: twitter:description
    content: The Chmod aliases allow to change the permissions (or access mode) of a file or directory.
  - name: twitter:title
    content: Chmod aliases - Dotfiles (ES)
  - name: og:title
    content: Chmod aliases - Dotfiles (ES)
  - name: og:description
    content: The Chmod aliases allow to change the permissions (or access mode) of a file or directory.
...
| chgrp  | `chgrp -v`          | Change group ownership of archivos or directories.                                                                                                                                                                      |
| chgrpr | `chgrp -Rv`         | Change group ownership of archivos or directories recursively.                                                                                                                                                          |
| chgrpu | `chgrp -Rv ${USER}` | Change group ownership of archivos or directories recursively to the current user.                                                                                                                                      |
| chmod  | `chmod -v`          | Change archivo mode bits.                                                                                                                                                                                               |
| chmodr | `chmod -Rv`         | Change archivo mode bits recursively.                                                                                                                                                                                   |
| chmodu | `chmod -Rv u+rwX`   | Change archivo mode bits recursively to the current user.                                                                                                                                                               |
| chmox  | `chmod +x`          | Make a archivo executable.                                                                                                                                                                                              |
| chown  | `chown -v`          | Change archivo owner and group.                                                                                                                                                                                         |
| chownr | `chown -Rv`         | Change archivo owner and group recursively.                                                                                                                                                                             |
| chownu | `chown -Rv ${USER}` | Change archivo owner and group recursively to the current user.                                                                                                                                                         |
