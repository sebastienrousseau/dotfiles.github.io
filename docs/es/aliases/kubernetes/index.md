...
lastUpdated: true
image: /logo.png
imageAlt: "Alias Kubernetes: simplifica la gestión de clusters preview"
canonical: /es/aliases/kubernetes/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "Alias Kubernetes: simplifica la gestión de clusters"
pageType: docs
schemaType: WebPage
