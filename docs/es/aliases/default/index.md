...
lastUpdated: true
image: /logo.png
imageAlt: "Alias predeterminados: atajos esenciales del shell preview"
canonical: /es/aliases/default/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "Alias predeterminados: atajos esenciales del shell"
pageType: docs
schemaType: WebPage
