...
lastUpdated: true
image: /logo.png
imageAlt: "Alias Pnpm: atajos para gestión rápida de paquetes preview"
canonical: /es/aliases/pnpm/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "Alias Pnpm: atajos para gestión rápida de paquetes"
pageType: docs
schemaType: WebPage
