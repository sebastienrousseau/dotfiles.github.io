...
lastUpdated: true
image: /logo.png
imageAlt: "Alias Disk Usage: monitoriza almacenamiento con shell preview"
canonical: /es/aliases/disk-usage/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "Alias Disk Usage: monitoriza almacenamiento con shell"
pageType: docs
schemaType: WebPage
