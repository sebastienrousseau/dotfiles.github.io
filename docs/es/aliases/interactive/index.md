...
lastUpdated: true
image: /logo.png
imageAlt: "Alias Interactivos: comandos seguros con confirmación preview"
canonical: /es/aliases/interactive/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "Alias Interactivos: comandos seguros con confirmación"
pageType: docs
schemaType: WebPage
