...
lastUpdated: true
image: /logo.png
imageAlt: "Alias Git: simplifica tu flujo de trabajo de control de versiones preview"
canonical: /es/aliases/git/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "Alias Git: simplifica tu flujo de trabajo de control de versiones"
pageType: docs
schemaType: WebPage
