...
lastUpdated: true
image: /logo.png
imageAlt: "Alias Configuration: acceso rápido a archivos de configuración preview"
canonical: /es/aliases/configuration/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "Alias Configuration: acceso rápido a archivos de configuración"
pageType: docs
schemaType: WebPage
