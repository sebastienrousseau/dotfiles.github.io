...
lastUpdated: true
image: /logo.png
imageAlt: "Alias Permission: atajos de permisos para el shell preview"
canonical: /es/aliases/permission/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "Alias Permission: atajos de permisos para el shell"
pageType: docs
schemaType: WebPage
