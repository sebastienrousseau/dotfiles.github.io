---
title: Guía de Firma de Commits con SSH | Dotfiles
description: Cómo firmar commits y etiquetas de Git con claves SSH usando Dotfiles. Configuración paso a paso para macOS, Linux y WSL con verificación de firmantes.
lang: es-ES
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: Guía de Firma de Commits con SSH preview
canonical: /es/guides/ssh-signing/
robots: index, follow
draft: false
noindex: false
sitemap: true
...
permalink: /es/guides/ssh-signing/
---
...
## Paso 3: Configurar firmantes autorizados
...
## Paso 5: Registrar en GitHub / GitLab
...
- [Guía de configuración GPG](/es/guides/gpg-configuration/)
