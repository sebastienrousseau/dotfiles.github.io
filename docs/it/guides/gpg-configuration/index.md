---
title: Guida alla configurazione GPG | Dotfiles
description: Come configurare GPG per la firma dei commit Git con Dotfiles. Generazione chiavi, integrazione Git e gestione Chezmoi su macOS, Linux e WSL.
lang: it-IT
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: Guida alla configurazione GPG preview
canonical: /it/guides/gpg-configuration/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Configurazione GPG
pageType: article
schemaType: TechArticle
permalink: /it/guides/gpg-configuration/
---

# Guida alla configurazione GPG

GPG (GNU Privacy Guard) è lo standard tradizionale per la firma dei commit:

## Perché la firma GPG?

- **Badge verificati** su GitHub, GitLab e Bitbucket.
- **Web of trust** — altri possono firmare la tua chiave.
- **Scadenza e revoca** — gestione del ciclo di vita integrata.
- **Crittografia** — la stessa chiave crittografa file e email.
...
## Passaggio 1: Generare una chiave GPG
...
## Passaggio 3: Configurare l'agente GPG
...
## Passaggio 5: Esportare e registrare la chiave
...
- [Guida alla firma SSH](/it/guides/ssh-signing/)
