...
lastUpdated: true
image: /logo.png
imageAlt: "Alias Lua: Accesso rapido agli interpreti Lua REPL preview"
canonical: /it/aliases/lua/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "Alias Lua: Accesso rapido agli interpreti Lua REPL"
pageType: docs
schemaType: WebPage
