---
title: Alias Disk Usage | Dotfiles
...
lastUpdated: true
image: /logo.png
imageAlt: Alias Disk Usage preview
canonical: /it/aliases/disk-usage/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Alias Disk Usage
pageType: docs
schemaType: WebPage
metaTitle: Alias Disk Usage - Dotfiles (IT)
permalink: /it/aliases/disk-usage/
sidebar: true
meta:
  - name: keywords
