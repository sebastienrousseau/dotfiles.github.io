...
lastUpdated: true
image: /logo.png
imageAlt: Alias preview
canonical: /it/aliases/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Alias
pageType: docs
schemaType: WebPage
metaTitle: Alias - Dotfiles (IT)
permalink: /it/aliases/
meta:
  - name: keywords
...
| [Benchmarks](benchmarks/) | Comandi di benchmarking |
