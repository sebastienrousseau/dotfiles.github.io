...
lastUpdated: true
image: /logo.png
imageAlt: "Alias Chmod : raccourcis de permissions pour le shell preview"
canonical: /fr/aliases/chmod/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "Alias Chmod : raccourcis de permissions pour le shell"
pageType: docs
schemaType: WebPage
