...
description: Ouvrez instantanément les fichiers de configuration shell, Git, SSH et serveur avec ces alias. Compatible avec macOS, Linux et WSL via Dotfiles.
lang: fr-FR
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: "Alias Configuration : accès rapide aux fichiers de config preview"
canonical: /fr/aliases/configuration/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "Alias Configuration : accès rapide aux fichiers de config"
pageType: docs
schemaType: WebPage
