...
lastUpdated: true
image: /logo.png
imageAlt: "Alias Permission : raccourcis de permissions pour le shell preview"
canonical: /fr/aliases/permission/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "Alias Permission : raccourcis de permissions pour le shell"
pageType: docs
schemaType: WebPage
metaTitle: Alias Permission | Dotfiles
permalink: /fr/aliases/permission/
sidebar: true
meta:
  - name: keywords
