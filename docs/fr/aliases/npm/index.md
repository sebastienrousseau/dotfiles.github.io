...
lastUpdated: true
image: /logo.png
imageAlt: "Alias NPM : simplifiez la gestion des paquets Node preview"
canonical: /fr/aliases/npm/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "Alias NPM : simplifiez la gestion des paquets Node"
pageType: docs
schemaType: WebPage
metaTitle: NPM Aliases | Dotfiles
permalink: /fr/aliases/npm/
sidebar: true
meta:
  - name: keywords
