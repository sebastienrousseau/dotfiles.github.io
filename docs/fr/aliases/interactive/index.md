...
lastUpdated: true
image: /logo.png
imageAlt: "Alias Interactifs : commandes sûres avec confirmations preview"
canonical: /fr/aliases/interactive/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "Alias Interactifs : commandes sûres avec confirmations"
pageType: docs
schemaType: WebPage
metaTitle: Alias Interactifs | Dotfiles
permalink: /fr/aliases/interactive/
sidebar: true
meta:
  - name: keywords
