...
lastUpdated: true
image: /logo.png
imageAlt: "Alias Pnpm : raccourcis pour gestion de paquets rapide preview"
canonical: /fr/aliases/pnpm/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "Alias Pnpm : raccourcis pour gestion de paquets rapide"
pageType: docs
schemaType: WebPage
metaTitle: Pnpm Aliases | Dotfiles
permalink: /fr/aliases/pnpm/
sidebar: true
meta:
  - name: keywords
