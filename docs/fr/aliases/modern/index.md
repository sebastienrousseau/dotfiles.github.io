...
lastUpdated: true
image: /logo.png
imageAlt: "Alias Modern : remplacements Unix basés sur Rust preview"
canonical: /fr/aliases/modern/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "Alias Modern : remplacements Unix basés sur Rust"
pageType: docs
schemaType: WebPage
metaTitle: Alias Modern | Dotfiles
permalink: /fr/aliases/modern/
sidebar: true
meta:
  - name: keywords
