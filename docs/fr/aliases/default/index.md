...
lastUpdated: true
image: /logo.png
imageAlt: "Alias par défaut : raccourcis essentiels du shell preview"
canonical: /fr/aliases/default/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "Alias par défaut : raccourcis essentiels du shell"
pageType: docs
schemaType: WebPage
