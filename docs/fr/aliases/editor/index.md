...
lastUpdated: true
image: /logo.png
imageAlt: "Alias Éditeur : raccourcis d’édition de texte preview"
canonical: /fr/aliases/editor/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "Alias Éditeur : raccourcis d’édition de texte"
pageType: docs
schemaType: WebPage
metaTitle: Alias Éditeur | Dotfiles
permalink: /fr/aliases/editor/
sidebar: true
meta:
  - name: keywords
