...
lastUpdated: true
image: /logo.png
imageAlt: "Alias Git : simplifiez votre workflow de versioning preview"
canonical: /fr/aliases/git/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "Alias Git : simplifiez votre workflow de versioning"
pageType: docs
schemaType: WebPage
metaTitle: Alias Git | Dotfiles
permalink: /fr/aliases/git/
sidebar: true
meta:
  - name: keywords
