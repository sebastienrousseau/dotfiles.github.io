...
lastUpdated: true
image: /logo.png
imageAlt: "Alias Fonts : gérer les polices système preview"
canonical: /fr/aliases/fonts/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "Alias Fonts : gérer les polices système"
pageType: docs
schemaType: WebPage
metaTitle: Alias Fonts | Dotfiles
permalink: /fr/aliases/fonts/
sidebar: true
meta:
  - name: keywords
