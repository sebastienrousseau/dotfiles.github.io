...
lastUpdated: true
image: /logo.png
imageAlt: "Alias Lua : Accès rapide aux interpréteurs Lua REPL preview"
canonical: /fr/aliases/lua/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "Alias Lua : Accès rapide aux interpréteurs Lua REPL"
pageType: docs
schemaType: WebPage
