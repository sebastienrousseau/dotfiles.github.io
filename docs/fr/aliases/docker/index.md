...
lastUpdated: true
image: /logo.png
imageAlt: "Alias Docker : simplifiez votre workflow conteneurs preview"
canonical: /fr/aliases/docker/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "Alias Docker : simplifiez votre workflow conteneurs"
pageType: docs
schemaType: WebPage
metaTitle: Alias Docker | Dotfiles
permalink: /fr/aliases/docker/
sidebar: true
meta:
  - name: keywords
