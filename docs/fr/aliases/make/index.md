...
lastUpdated: true
image: /logo.png
imageAlt: "Alias Make : simplifiez votre workflow de build preview"
canonical: /fr/aliases/make/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "Alias Make : simplifiez votre workflow de build"
pageType: docs
schemaType: WebPage
metaTitle: Make Aliases | Dotfiles
permalink: /fr/aliases/make/
sidebar: true
meta:
  - name: keywords
