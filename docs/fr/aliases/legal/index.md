...
lastUpdated: true
image: /logo.png
imageAlt: "Alias Legal : outils de conformité open source preview"
canonical: /fr/aliases/legal/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "Alias Legal : outils de conformité open source"
pageType: docs
schemaType: WebPage
metaTitle: Alias Legal | Dotfiles
permalink: /fr/aliases/legal/
sidebar: true
meta:
  - name: keywords
