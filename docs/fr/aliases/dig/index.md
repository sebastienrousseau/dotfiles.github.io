...
lastUpdated: true
image: /logo.png
imageAlt: "Alias Dig : raccourcis DNS pour le terminal preview"
canonical: /fr/aliases/dig/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "Alias Dig : raccourcis DNS pour le terminal"
pageType: docs
schemaType: WebPage
metaTitle: Alias Dig | Dotfiles
permalink: /fr/aliases/dig/
sidebar: true
meta:
  - name: keywords
