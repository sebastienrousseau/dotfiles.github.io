...
lastUpdated: true
image: /logo.png
imageAlt: "Alias Kubernetes : simplifiez la gestion des clusters preview"
canonical: /fr/aliases/kubernetes/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "Alias Kubernetes : simplifiez la gestion des clusters"
pageType: docs
schemaType: WebPage
metaTitle: Alias Kubernetes | Dotfiles
permalink: /fr/aliases/kubernetes/
sidebar: true
meta:
  - name: keywords
