...
lastUpdated: true
image: /logo.png
imageAlt: "Alias Disk Usage : surveiller le stockage avec le shell preview"
canonical: /fr/aliases/disk-usage/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "Alias Disk Usage : surveiller le stockage avec le shell"
pageType: docs
schemaType: WebPage
metaTitle: Alias Disk Usage | Dotfiles
permalink: /fr/aliases/disk-usage/
sidebar: true
meta:
  - name: keywords
