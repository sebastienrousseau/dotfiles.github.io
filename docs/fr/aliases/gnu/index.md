...
lastUpdated: true
image: /logo.png
imageAlt: "Alias GNU Coreutils : raccourcis shell pour Linux preview"
canonical: /fr/aliases/gnu/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "Alias GNU Coreutils : raccourcis shell pour Linux"
pageType: docs
schemaType: WebPage
metaTitle: Alias GNU Coreutils | Dotfiles
permalink: /fr/aliases/gnu/
sidebar: true
meta:
  - name: keywords
