...
lastUpdated: true
image: /logo.png
imageAlt: "Alias macOS : raccourcis shell pour Mac preview"
canonical: /fr/aliases/macOS/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "Alias macOS : raccourcis shell pour Mac"
pageType: docs
schemaType: WebPage
metaTitle: Alias macOS | Dotfiles
permalink: /fr/aliases/macOS/
sidebar: true
meta:
  - name: keywords
