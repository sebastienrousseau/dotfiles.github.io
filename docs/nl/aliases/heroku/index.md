...
lastUpdated: true
image: /logo.png
imageAlt: "Heroku-aliassen: Shell-snelkoppelingen voor de Heroku CLI preview"
canonical: /nl/aliases/heroku/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "Heroku-aliassen: Shell-snelkoppelingen voor de Heroku CLI"
pageType: docs
schemaType: WebPage
