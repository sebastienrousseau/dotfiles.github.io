...
lastUpdated: true
image: /logo.png
imageAlt: "Git-aliassen: Stroomlijn je versiebeheer-workflow preview"
canonical: /nl/aliases/git/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "Git-aliassen: Stroomlijn je versiebeheer-workflow"
pageType: docs
schemaType: WebPage
