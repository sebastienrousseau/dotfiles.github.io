...
lastUpdated: true
image: /logo.png
imageAlt: "Dig-aliassen: DNS-lookup snelkoppelingen voor de terminal preview"
canonical: /nl/aliases/dig/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "Dig-aliassen: DNS-lookup snelkoppelingen voor de terminal"
pageType: docs
schemaType: WebPage
