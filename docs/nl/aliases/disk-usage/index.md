...
lastUpdated: true
image: /logo.png
imageAlt: "Schijfgebruik-aliassen: Monitor opslag met shell-commando's preview"
canonical: /nl/aliases/disk-usage/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "Schijfgebruik-aliassen: Monitor opslag met shell-commando's"
pageType: docs
schemaType: WebPage
