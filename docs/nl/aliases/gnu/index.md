...
lastUpdated: true
image: /logo.png
imageAlt: "GNU Coreutils-aliassen: Shell-snelkoppelingen voor Linux preview"
canonical: /nl/aliases/gnu/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "GNU Coreutils-aliassen: Shell-snelkoppelingen voor Linux"
pageType: docs
schemaType: WebPage
