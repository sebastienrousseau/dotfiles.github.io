...
lastUpdated: true
image: /logo.png
imageAlt: "Lua Aliassen: Snelle Toegang tot Lua REPL Interpreters preview"
canonical: /nl/aliases/lua/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "Lua Aliassen: Snelle Toegang tot Lua REPL Interpreters"
pageType: docs
schemaType: WebPage
