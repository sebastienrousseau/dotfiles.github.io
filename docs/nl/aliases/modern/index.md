...
lastUpdated: true
image: /logo.png
imageAlt: "Moderne tooling-aliassen: Rust-gebaseerde Unix-vervangingen preview"
canonical: /nl/aliases/modern/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "Moderne tooling-aliassen: Rust-gebaseerde Unix-vervangingen"
pageType: docs
schemaType: WebPage
