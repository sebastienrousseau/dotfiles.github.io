---
title: Mkdir Takma Adları | Dotfiles
description: Kısa klasör oluşturma komutları. Dotfiles v0.2.495 genel bakış. macOS, Linux ve WSL ile Dotfiles üzerinden uyumlu.
lang: tr-TR
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: Mkdir Takma Adları | Dotfiles önizleme
canonical: /tr/aliases/mkdir/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Mkdir Takma Adları
pageType: docs
schemaType: WebPage
permalink: /tr/aliases/mkdir/
---

# Mkdir Takma Adları

Kısa klasör oluşturma komutları.
