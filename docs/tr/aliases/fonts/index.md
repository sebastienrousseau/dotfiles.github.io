---
title: Yazı Tipi Takma Adları | Dotfiles
description: Kısa yazı tipi önbellek komutları. Dotfiles v0.2.495 genel bakış.
lang: tr-TR
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: Yazı Tipi Takma Adları | Dotfiles önizleme
canonical: /tr/aliases/fonts/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Yazı Tipi Takma Adları
pageType: docs
schemaType: WebPage
permalink: /tr/aliases/fonts/
---

# Yazı Tipi Takma Adları

Kısa yazı tipi önbellek komutları.
