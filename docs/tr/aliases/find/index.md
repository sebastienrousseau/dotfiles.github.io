---
title: Bul Takma Adları | Dotfiles
description: Kısa dosya arama komutları. Dotfiles v0.2.495 genel bakış. macOS, Linux ve WSL ile Dotfiles üzerinden uyumlu.
lang: tr-TR
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: Bul Takma Adları | Dotfiles önizleme
canonical: /tr/aliases/find/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Bul Takma Adları
pageType: docs
schemaType: WebPage
permalink: /tr/aliases/find/
---

# Bul Takma Adları

Kısa dosya arama komutları.
