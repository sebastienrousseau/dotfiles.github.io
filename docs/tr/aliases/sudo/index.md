---
title: Sudo Takma Adları | Dotfiles
description: Kısa sudo komutları. Dotfiles v0.2.495 genel bakış. macOS, Linux ve WSL ile Dotfiles üzerinden uyumlu.
lang: tr-TR
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: Sudo Takma Adları | Dotfiles önizleme
canonical: /tr/aliases/sudo/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Sudo Takma Adları
pageType: docs
schemaType: WebPage
permalink: /tr/aliases/sudo/
---
