---
title: Hukuki Takma Adları | Dotfiles
description: Kısa hukuki kontrol komutları. Dotfiles v0.2.495 genel bakış. macOS, Linux ve WSL ile Dotfiles üzerinden uyumlu.
lang: tr-TR
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: Hukuki Takma Adları | Dotfiles önizleme
canonical: /tr/aliases/legal/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Hukuki Takma Adları
pageType: docs
schemaType: WebPage
permalink: /tr/aliases/legal/
---

# Hukuki Takma Adları

Kısa hukuki kontrol komutları.
