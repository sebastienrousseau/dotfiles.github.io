---
title: Git Takma Adları | Dotfiles
description: Kısa Git komutları. Dotfiles v0.2.495 genel bakış.
lang: tr-TR
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: Git Takma Adları | Dotfiles önizleme
canonical: /tr/aliases/git/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Git Takma Adları
pageType: docs
schemaType: WebPage
permalink: /tr/aliases/git/
---
