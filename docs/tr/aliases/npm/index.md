---
title: NPM Takma Adları | Dotfiles
description: Kısa npm komutları. Dotfiles v0.2.495 genel bakış. macOS, Linux ve WSL ile Dotfiles üzerinden uyumlu.
lang: tr-TR
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: NPM Takma Adları | Dotfiles önizleme
canonical: /tr/aliases/npm/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: NPM Takma Adları
pageType: docs
schemaType: WebPage
permalink: /tr/aliases/npm/
---
