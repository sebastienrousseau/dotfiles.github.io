---
title: System Başvuru eki | Dotfiles
description: Dotfiles v0.2.495'te System için eksiksiz takma ad ve yardımcı fonksiyon referansı. macOS, Linux ve WSL için her kısayol, kullanım örneği ve shell fonksiyonunu içerir.
lang: tr-TR
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: System Başvuru eki | Dotfiles preview
canonical: /tr/aliases/system/reference/
robots: index, follow
draft: false
noindex: false
sitemap: true
...
pageType: docs
schemaType: WebPage
permalink: /tr/aliases/system/reference/
---
