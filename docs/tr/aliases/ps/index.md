---
title: PS Takma Adları | Dotfiles
description: Kısa süreç listeleme komutları. Dotfiles v0.2.495 genel bakış. macOS, Linux ve WSL ile Dotfiles üzerinden uyumlu.
lang: tr-TR
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: PS Takma Adları | Dotfiles önizleme
canonical: /tr/aliases/ps/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: PS Takma Adları
pageType: docs
schemaType: WebPage
permalink: /tr/aliases/ps/
---

# PS Takma Adları

Kısa süreç listeleme komutları.
