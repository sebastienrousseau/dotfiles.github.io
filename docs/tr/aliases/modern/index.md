---
title: Modern Takma Adları | Dotfiles
description: Kısa modern araç komutları. Dotfiles v0.2.495 genel bakış. macOS, Linux ve WSL ile Dotfiles üzerinden uyumlu.
lang: tr-TR
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: Modern Takma Adları | Dotfiles önizleme
canonical: /tr/aliases/modern/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Modern Takma Adları
pageType: docs
schemaType: WebPage
permalink: /tr/aliases/modern/
---

# Modern Takma Adları

Kısa modern araç komutları.
