---
title: Güncelleme Takma Adları | Dotfiles
description: Kısa güncelleme komutları. Dotfiles v0.2.495 genel bakış. macOS, Linux ve WSL ile Dotfiles üzerinden uyumlu.
lang: tr-TR
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: Güncelleme Takma Adları | Dotfiles önizleme
canonical: /tr/aliases/update/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Güncelleme Takma Adları
pageType: docs
schemaType: WebPage
permalink: /tr/aliases/update/
---

# Güncelleme Takma Adları

Kısa güncelleme komutları.
...
Bu kategori için takma ad örneği bulunmamaktadır.
