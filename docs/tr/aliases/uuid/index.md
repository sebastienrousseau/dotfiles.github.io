---
title: UUID Takma Adları | Dotfiles
description: Kısa UUID komutları. Dotfiles v0.2.495 genel bakış.
lang: tr-TR
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: UUID Takma Adları | Dotfiles önizleme
canonical: /tr/aliases/uuid/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: UUID Takma Adları
pageType: docs
schemaType: WebPage
permalink: /tr/aliases/uuid/
---
