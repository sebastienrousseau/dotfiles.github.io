---
title: Make Takma Adları | Dotfiles
description: Kısa make komutları. Dotfiles v0.2.495 genel bakış. macOS, Linux ve WSL ile Dotfiles üzerinden uyumlu.
lang: tr-TR
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: Make Takma Adları | Dotfiles önizleme
canonical: /tr/aliases/make/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Make Takma Adları
pageType: docs
schemaType: WebPage
permalink: /tr/aliases/make/
---
