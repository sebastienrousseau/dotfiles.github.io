---
title: นามแฝง Kubernetes | Dotfiles
description: คำสั่ง kubectl และ Helm แบบสั้น ภาพรวมสำหรับ Dotfiles v0.2.495 รองรับ macOS, Linux และ WSL ผ่าน Dotfiles
lang: th-TH
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: นามแฝง Kubernetes | Dotfiles preview
canonical: /th/aliases/kubernetes/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: นามแฝง Kubernetes
pageType: docs
schemaType: WebPage
permalink: /th/aliases/kubernetes/
---

# นามแฝง Kubernetes

คำสั่ง kubectl และ Helm แบบสั้น
