---
title: นามแฝง GNU | Dotfiles
description: คำสั่งยูทิลิตี้ GNU แบบสั้น ภาพรวมสำหรับ Dotfiles v0.2.495 รองรับ macOS, Linux และ WSL ผ่าน Dotfiles
lang: th-TH
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: นามแฝง GNU | Dotfiles preview
canonical: /th/aliases/gnu/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: นามแฝง GNU
pageType: docs
schemaType: WebPage
permalink: /th/aliases/gnu/
---

# นามแฝง GNU

คำสั่งยูทิลิตี้ GNU แบบสั้น
...
ไม่มีตัวอย่างนามแฝงสำหรับหมวดหมู่นี้
