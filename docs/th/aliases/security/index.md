---
title: นามแฝง Security | Dotfiles
description: คำสั่งความปลอดภัยแบบสั้น ภาพรวมสำหรับ Dotfiles v0.2.495 รองรับ macOS, Linux และ WSL ผ่าน Dotfiles
lang: th-TH
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: นามแฝง Security | Dotfiles preview
canonical: /th/aliases/security/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: นามแฝง Security
pageType: docs
schemaType: WebPage
permalink: /th/aliases/security/
---

# นามแฝง Security

คำสั่งความปลอดภัยแบบสั้น
