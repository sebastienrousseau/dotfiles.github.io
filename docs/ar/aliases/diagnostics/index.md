...
lastUpdated: true
image: /logo.png
imageAlt: "اختصارات Diagnostics: صحة النظام وأوامر الإصلاح الذاتي preview"
canonical: /ar/aliases/diagnostics/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "اختصارات Diagnostics: صحة النظام وأوامر الإصلاح الذاتي"
pageType: docs
schemaType: WebPage
