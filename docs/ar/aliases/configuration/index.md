...
lastUpdated: true
image: /logo.png
imageAlt: "اختصارات Configuration: وصول سريع لملفات الإعدادات preview"
canonical: /ar/aliases/configuration/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "اختصارات Configuration: وصول سريع لملفات الإعدادات"
pageType: docs
schemaType: WebPage
