...
lastUpdated: true
image: /logo.png
imageAlt: "اختصارات Google Cloud: بسّط سير عمل gcloud CLI preview"
canonical: /ar/aliases/gcloud/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "اختصارات Google Cloud: بسّط سير عمل gcloud CLI"
pageType: docs
schemaType: WebPage
