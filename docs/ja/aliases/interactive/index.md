---
title: インタラクティブエイリアス | Dotfiles
description: 破壊的操作の前に確認プロンプトを追加する安全なシェルエイリアス。rm、mv、cpの誤操作を防止。
lang: ja-JP
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: インタラクティブエイリアス preview
canonical: /ja/aliases/interactive/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: インタラクティブエイリアス
pageType: docs
schemaType: WebPage
metaTitle: インタラクティブエイリアス - Dotfiles (JP)
permalink: /ja/aliases/interactive/
sidebar: true
meta:
  - name: keywords
