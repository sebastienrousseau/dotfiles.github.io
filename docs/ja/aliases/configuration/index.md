---
title: Configurationエイリアス | Dotfiles
description: BashとZsh用のシェルエイリアスで、シェル、Git、SSH、サーバー設定ファイルを即座に開きます。
lang: ja-JP
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: Configurationエイリアス preview
canonical: /ja/aliases/configuration/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Configurationエイリアス
pageType: docs
schemaType: WebPage
metaTitle: Configurationエイリアス - Dotfiles (JP)
permalink: /ja/aliases/configuration/
sidebar: true
meta:
  - name: keywords
