---
title: Kubernetesエイリアス | Dotfiles
description: Kubernetesワークフロー用シェルエイリアス。kubectl、Helm、k9sでPod、コンテキスト、ネームスペースを効率的に管理。
lang: ja-JP
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: Kubernetesエイリアス preview
canonical: /ja/aliases/kubernetes/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Kubernetesエイリアス
pageType: docs
schemaType: WebPage
metaTitle: Kubernetesエイリアス - Dotfiles (JP)
permalink: /ja/aliases/kubernetes/
sidebar: true
meta:
  - name: keywords
