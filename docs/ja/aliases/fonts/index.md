---
title: Fontsエイリアス | Dotfiles
description: システムフォントとフォントキャッシュを管理するためのシェルエイリアス。 macOS・Linux・WSL対応。Dotfilesで管理。
lang: ja-JP
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: Fontsエイリアス preview
canonical: /ja/aliases/fonts/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Fontsエイリアス
pageType: docs
schemaType: WebPage
metaTitle: Fontsエイリアス - Dotfiles (JP)
permalink: /ja/aliases/fonts/
sidebar: true
meta:
  - name: keywords
