---
title: GNU Coreutilsエイリアス | Dotfiles
description: GNU Coreutilsエイリアス。ファイル管理、テキスト処理、チェックサムユーティリティのショートカット。
lang: ja-JP
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: GNU Coreutilsエイリアス preview
canonical: /ja/aliases/gnu/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: GNU Coreutilsエイリアス
pageType: docs
schemaType: WebPage
metaTitle: GNU Coreutilsエイリアス - Dotfiles (JP)
permalink: /ja/aliases/gnu/
sidebar: true
meta:
  - name: keywords
