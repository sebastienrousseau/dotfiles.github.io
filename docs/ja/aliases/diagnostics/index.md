---
title: Diagnosticsエイリアス | Dotfiles
description: 自己修復とシステムヘルスチェックのためのシェルエイリアス。dotfiles環境の問題を検出して修復します。
lang: ja-JP
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: Diagnosticsエイリアス preview
canonical: /ja/aliases/diagnostics/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Diagnosticsエイリアス
pageType: docs
schemaType: WebPage
metaTitle: Diagnosticsエイリアス - Dotfiles (JP)
permalink: /ja/aliases/diagnostics/
sidebar: true
meta:
  - name: keywords
