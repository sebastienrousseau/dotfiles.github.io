---
title: Complianceエイリアス | Dotfiles
description: ターミナル環境での規制準拠、プライバシー強制、設定監査のためのシェルエイリアス。
lang: ja-JP
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: Complianceエイリアス preview
canonical: /ja/aliases/compliance/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Complianceエイリアス
pageType: docs
schemaType: WebPage
metaTitle: Complianceエイリアス - Dotfiles (JP)
permalink: /ja/aliases/compliance/
sidebar: true
meta:
  - name: keywords
