...
lastUpdated: true
image: /logo.png
imageAlt: Lua エイリアス：Lua REPL インタープリターへの素早いアクセス preview
canonical: /ja/aliases/lua/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Lua エイリアス：Lua REPL インタープリターへの素早いアクセス
pageType: docs
schemaType: WebPage
metaTitle: Lua エイリアス | Dotfiles
permalink: /ja/aliases/lua/
sidebar: true
meta:
  - name: keywords
