---
title: Aliasy Konfiguracji | Dotfiles
description: Skrocone polecenia konfiguracji. Przeglad dla Dotfiles v0.2.495.
lang: pl-PL
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: Aliasy Konfiguracji | Dotfiles preview
canonical: /pl/aliases/configuration/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Aliasy Konfiguracji
pageType: docs
schemaType: WebPage
permalink: /pl/aliases/configuration/
---

# Aliasy Konfiguracji

Skrocone polecenia konfiguracji.
