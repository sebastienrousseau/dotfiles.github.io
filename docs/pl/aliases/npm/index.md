---
title: Aliasy NPM | Dotfiles
description: Skrocone polecenia npm. Przeglad dla Dotfiles v0.2.495. Kompatybilny z macOS, Linux i WSL przez Dotfiles.
lang: pl-PL
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: Aliasy NPM | Dotfiles preview
canonical: /pl/aliases/npm/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Aliasy NPM
pageType: docs
schemaType: WebPage
permalink: /pl/aliases/npm/
---

# Aliasy NPM

Skrocone polecenia npm.
