---
title: Aliasy UUID | Dotfiles
description: Skrocone polecenia UUID. Przeglad dla Dotfiles v0.2.495. Kompatybilny z macOS, Linux i WSL przez Dotfiles.
lang: pl-PL
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: Aliasy UUID | Dotfiles preview
canonical: /pl/aliases/uuid/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Aliasy UUID
pageType: docs
schemaType: WebPage
permalink: /pl/aliases/uuid/
---

# Aliasy UUID

Skrocone polecenia UUID.
