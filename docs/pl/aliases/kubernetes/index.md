---
title: Aliasy Kubernetes | Dotfiles
description: Skrocone polecenia kubectl i Helm. Przeglad dla Dotfiles v0.2.495. Kompatybilny z macOS, Linux i WSL przez Dotfiles.
lang: pl-PL
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: Aliasy Kubernetes | Dotfiles preview
canonical: /pl/aliases/kubernetes/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Aliasy Kubernetes
pageType: docs
schemaType: WebPage
permalink: /pl/aliases/kubernetes/
---

# Aliasy Kubernetes

Skrocone polecenia kubectl i Helm.
...
- `kaf` -> `kubectl apply -f`
- `kctx` -> `kubectx`
- `kctxc` -> `'kubectx -c' # Biezacy kontekst`
