---
title: 配置別名 | Dotfiles
description: 配置指令簡寫。Dotfiles v0.2.495 概覽。 相容 macOS、Linux 和 WSL。透過 Dotfiles 管理。
lang: zh-TW
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: 配置別名 | Dotfiles 預覽
canonical: /zh-tw/aliases/configuration/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: 配置別名
pageType: docs
schemaType: WebPage
permalink: /zh-tw/aliases/configuration/
---
