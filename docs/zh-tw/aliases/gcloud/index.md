---
title: Gcloud 別名 | Dotfiles
description: Gcloud 指令簡寫。Dotfiles v0.2.495 概覽。 相容 macOS、Linux 和 WSL。透過 Dotfiles 管理。
lang: zh-TW
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: Gcloud 別名 | Dotfiles 預覽
canonical: /zh-tw/aliases/gcloud/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Gcloud 別名
pageType: docs
schemaType: WebPage
permalink: /zh-tw/aliases/gcloud/
---
