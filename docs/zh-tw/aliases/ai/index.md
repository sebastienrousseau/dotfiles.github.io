---
title: AI 別名 | Dotfiles
description: AI 指令簡寫。Dotfiles v0.2.495 概覽。 相容 macOS、Linux 和 WSL。透過 Dotfiles 管理。
lang: zh-TW
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: AI 別名 | Dotfiles 預覽
canonical: /zh-tw/aliases/ai/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: AI 別名
pageType: docs
schemaType: WebPage
permalink: /zh-tw/aliases/ai/
---
