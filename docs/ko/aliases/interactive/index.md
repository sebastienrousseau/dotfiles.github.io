---
title: Interactive 별칭 | Dotfiles
description: rm, mv, cp와 같은 파괴적 작업 전에 확인 프롬프트를 추가하는 셸 별칭. 실수로 인한 파일 삭제를 방지합니다.
lang: ko-KR
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: Interactive 별칭 preview
canonical: /ko/aliases/interactive/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Interactive 별칭
pageType: docs
schemaType: WebPage
metaTitle: Interactive 별칭 - Dotfiles (KR)
permalink: /ko/aliases/interactive/
sidebar: true
meta:
  - name: keywords
