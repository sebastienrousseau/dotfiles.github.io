---
title: Modern Tooling 별칭 | Dotfiles
description: eza, bat, ripgrep을 위한 현대적 셸 별칭. 레거시 Unix 도구를 더 빠른 Rust 기반 대안으로 교체합니다.
lang: ko-KR
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: Modern Tooling 별칭 preview
canonical: /ko/aliases/modern/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Modern Tooling 별칭
pageType: docs
schemaType: WebPage
metaTitle: Modern Tooling 별칭 - Dotfiles (KR)
permalink: /ko/aliases/modern/
sidebar: true
meta:
  - name: keywords
