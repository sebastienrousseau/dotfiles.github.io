---
title: מדריך הגדרת GPG | Dotfiles
description: כיצד להגדיר GPG לחתימת קומיטים ב-Git עם Dotfiles. יצירת מפתחות, אינטגרציית Git וניהול Chezmoi ב-macOS, Linux ו-WSL.
lang: he-IL
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: מדריך הגדרת GPG preview
canonical: /he/guides/gpg-configuration/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: הגדרת GPG
pageType: article
schemaType: TechArticle
permalink: /he/guides/gpg-configuration/
---

# מדריך הגדרת GPG

GPG (GNU Privacy Guard) הוא הסטנדרט המסורתי לחתימת קומיטים:

## למה חתימת GPG?

- **תגי אימות** ב-GitHub, GitLab ו-Bitbucket.
- **רשת אמון** — אחרים יכולים לחתום על המפתח שלך.
- **תפוגה וביטול מפתחות** — ניהול מחזור חיים מובנה.
- **הצפנה** — אותו מפתח מצפין קבצים ואימייל.
...
- [מדריך חתימת SSH](/he/guides/ssh-signing/)
