...
lastUpdated: true
image: /logo.png
imageAlt: "קיצורי Modern Tooling: תחליפי Unix מבוססי Rust preview"
canonical: /he/aliases/modern/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "קיצורי Modern Tooling: תחליפי Unix מבוססי Rust"
pageType: docs
schemaType: WebPage
