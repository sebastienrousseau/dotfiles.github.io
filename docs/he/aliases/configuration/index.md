...
lastUpdated: true
image: /logo.png
imageAlt: "קיצורי Configuration: גישה מהירה לקבצי תצורה preview"
canonical: /he/aliases/configuration/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "קיצורי Configuration: גישה מהירה לקבצי תצורה"
pageType: docs
schemaType: WebPage
