...
lastUpdated: true
image: /logo.png
imageAlt: "קיצורי Diagnostics: פקודות תקינות מערכת ותיקון עצמי preview"
canonical: /he/aliases/diagnostics/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "קיצורי Diagnostics: פקודות תקינות מערכת ותיקון עצמי"
pageType: docs
schemaType: WebPage
