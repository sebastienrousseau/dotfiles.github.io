...
lastUpdated: true
image: /logo.png
imageAlt: "קיצורי Kubernetes: ייעל את ניהול האשכולות שלך preview"
canonical: /he/aliases/kubernetes/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "קיצורי Kubernetes: ייעל את ניהול האשכולות שלך"
pageType: docs
schemaType: WebPage
