...
lastUpdated: true
image: /logo.png
imageAlt: "קיצורי Docker: ייעל את זרימת העבודה עם קונטיינרים preview"
canonical: /he/aliases/docker/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "קיצורי Docker: ייעל את זרימת העבודה עם קונטיינרים"
pageType: docs
schemaType: WebPage
