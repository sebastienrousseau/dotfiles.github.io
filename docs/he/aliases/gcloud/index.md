...
lastUpdated: true
image: /logo.png
imageAlt: "קיצורי Google Cloud: ייעל את זרימת העבודה עם gcloud CLI preview"
canonical: /he/aliases/gcloud/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "קיצורי Google Cloud: ייעל את זרימת העבודה עם gcloud CLI"
pageType: docs
schemaType: WebPage
