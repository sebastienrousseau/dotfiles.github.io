---
title: Аліаси редактора | Dotfiles
description: Короткі команди редагування. Огляд для Dotfiles v0.2.495. Сумісно з macOS, Linux та WSL через Dotfiles.
lang: uk-UA
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: Аліаси редактора | Dotfiles preview
canonical: /uk/aliases/editor/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Аліаси редактора
pageType: docs
schemaType: WebPage
permalink: /uk/aliases/editor/
---

# Аліаси редактора

Короткі команди редагування.
...
- `emacsc` → `emacsclient`
- `emacsrc` → `emacs ~/.emacs`
- `et` → `"emacs -nw" # Термінальний режим`
- `mate` → `${EDITOR}`
- `n` → `${EDITOR}`
