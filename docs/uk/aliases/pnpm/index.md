---
title: Аліаси PNPM | Dotfiles
description: Короткі команди pnpm. Огляд для Dotfiles v0.2.495. Сумісно з macOS, Linux та WSL через Dotfiles.
lang: uk-UA
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: Аліаси PNPM | Dotfiles preview
canonical: /uk/aliases/pnpm/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Аліаси PNPM
pageType: docs
schemaType: WebPage
permalink: /uk/aliases/pnpm/
---

# Аліаси PNPM

Короткі команди pnpm.
