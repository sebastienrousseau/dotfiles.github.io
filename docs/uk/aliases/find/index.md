---
title: Аліаси пошуку | Dotfiles
description: Короткі команди пошуку файлів. Огляд для Dotfiles v0.2.495. Сумісно з macOS, Linux та WSL через Dotfiles.
lang: uk-UA
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: Аліаси пошуку | Dotfiles preview
canonical: /uk/aliases/find/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Аліаси пошуку
pageType: docs
schemaType: WebPage
permalink: /uk/aliases/find/
---

# Аліаси пошуку

Короткі команди пошуку файлів.
