---
title: Аліаси Kubernetes | Dotfiles
description: Короткі команди kubectl та Helm. Огляд для Dotfiles v0.2.495. Сумісно з macOS, Linux та WSL через Dotfiles.
lang: uk-UA
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: Аліаси Kubernetes | Dotfiles preview
canonical: /uk/aliases/kubernetes/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Аліаси Kubernetes
pageType: docs
schemaType: WebPage
permalink: /uk/aliases/kubernetes/
---

# Аліаси Kubernetes

Короткі команди kubectl та Helm.
...
- `kaf` → `kubectl apply -f`
- `kctx` → `kubectx`
- `kctxc` → `'kubectx -c' # Поточний контекст`
