---
title: Аліаси Make | Dotfiles
description: Короткі команди make. Огляд для Dotfiles v0.2.495. Сумісно з macOS, Linux та WSL через Dotfiles.
lang: uk-UA
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: Аліаси Make | Dotfiles preview
canonical: /uk/aliases/make/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Аліаси Make
pageType: docs
schemaType: WebPage
permalink: /uk/aliases/make/
---

# Аліаси Make

Короткі команди make.
