---
title: Аліаси Terraform | Dotfiles
description: Короткі команди Terraform. Огляд для Dotfiles v0.2.495. Сумісно з macOS, Linux та WSL через Dotfiles.
lang: uk-UA
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: Аліаси Terraform | Dotfiles preview
canonical: /uk/aliases/terraform/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Аліаси Terraform
pageType: docs
schemaType: WebPage
permalink: /uk/aliases/terraform/
---

# Аліаси Terraform

Короткі команди Terraform.
