---
title: Аліаси очищення | Dotfiles
description: Короткі команди очищення екрана. Огляд для Dotfiles v0.2.495. Сумісно з macOS, Linux та WSL через Dotfiles.
lang: uk-UA
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: Аліаси очищення | Dotfiles preview
canonical: /uk/aliases/clear/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Аліаси очищення
pageType: docs
schemaType: WebPage
permalink: /uk/aliases/clear/
---

# Аліаси очищення

Короткі команди очищення екрана.
