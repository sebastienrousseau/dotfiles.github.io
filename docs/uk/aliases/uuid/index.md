---
title: Аліаси UUID | Dotfiles
description: Короткі команди UUID. Огляд для Dotfiles v0.2.495. Сумісно з macOS, Linux та WSL через Dotfiles.
lang: uk-UA
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: Аліаси UUID | Dotfiles preview
canonical: /uk/aliases/uuid/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Аліаси UUID
pageType: docs
schemaType: WebPage
permalink: /uk/aliases/uuid/
---

# Аліаси UUID

Короткі команди UUID.
