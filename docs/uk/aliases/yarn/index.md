---
title: Аліаси Yarn | Dotfiles
description: Короткі команди Yarn. Огляд для Dotfiles v0.2.495. Сумісно з macOS, Linux та WSL через Dotfiles.
lang: uk-UA
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: Аліаси Yarn | Dotfiles preview
canonical: /uk/aliases/yarn/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Аліаси Yarn
pageType: docs
schemaType: WebPage
permalink: /uk/aliases/yarn/
---

# Аліаси Yarn

Короткі команди Yarn.
