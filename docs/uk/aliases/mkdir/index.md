---
title: Аліаси Mkdir | Dotfiles
description: Короткі команди створення каталогів. Огляд для Dotfiles v0.2.495. Сумісно з macOS, Linux та WSL через Dotfiles.
lang: uk-UA
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: Аліаси Mkdir | Dotfiles preview
canonical: /uk/aliases/mkdir/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Аліаси Mkdir
pageType: docs
schemaType: WebPage
permalink: /uk/aliases/mkdir/
---

# Аліаси Mkdir

Короткі команди створення каталогів.
