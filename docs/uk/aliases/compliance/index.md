---
title: Аліаси відповідності | Dotfiles
description: Короткі команди відповідності. Огляд для Dotfiles v0.2.495. Сумісно з macOS, Linux та WSL через Dotfiles.
lang: uk-UA
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: Аліаси відповідності | Dotfiles preview
canonical: /uk/aliases/compliance/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Аліаси відповідності
pageType: docs
schemaType: WebPage
permalink: /uk/aliases/compliance/
---

# Аліаси відповідності

Короткі команди відповідності.
