---
title: Аліаси Sudo | Dotfiles
description: Короткі команди sudo. Огляд для Dotfiles v0.2.495. Сумісно з macOS, Linux та WSL через Dotfiles.
lang: uk-UA
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: Аліаси Sudo | Dotfiles preview
canonical: /uk/aliases/sudo/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Аліаси Sudo
pageType: docs
schemaType: WebPage
permalink: /uk/aliases/sudo/
---

# Аліаси Sudo

Короткі команди sudo.
