---
title: Аліаси Go | Dotfiles
description: Короткі команди інструментів Go. Огляд для Dotfiles v0.2.495. Сумісно з macOS, Linux та WSL через Dotfiles.
lang: uk-UA
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: Аліаси Go | Dotfiles preview
canonical: /uk/aliases/go/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Аліаси Go
pageType: docs
schemaType: WebPage
permalink: /uk/aliases/go/
---

# Аліаси Go

Короткі команди інструментів Go.
