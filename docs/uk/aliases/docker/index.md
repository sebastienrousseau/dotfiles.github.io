---
title: Аліаси Docker | Dotfiles
description: Короткі команди Docker. Огляд для Dotfiles v0.2.495.
lang: uk-UA
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: Аліаси Docker | Dotfiles preview
canonical: /uk/aliases/docker/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Аліаси Docker
pageType: docs
schemaType: WebPage
permalink: /uk/aliases/docker/
---

# Аліаси Docker

Короткі імена команд Docker.
