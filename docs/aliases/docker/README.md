---
title: "Docker Aliases: Streamline Your Container Workflow"
description: "Comprehensive Docker aliases for containers, images, volumes, networks, Compose, and Swarm. Boost productivity with short commands."
lang: en-GB
metaTitle: "Docker Aliases | Dotfiles"
...
Streamline your container workflow with intuitive shortcuts for Docker, Compose, and Swarm.

![Dotfiles banner][banner]

## Overview

These aliases are defined in `docker.aliases.sh` and are automatically loaded by chezmoi. They provide a comprehensive set of shortcuts for Docker development, covering containers, images, volumes, networks, Docker Compose, and Docker Swarm operations.
