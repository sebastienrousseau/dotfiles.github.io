...
## ⏺️ Record changes to the repository
...
## 🏷️ Create, list, delete or verify a tag object signed with GPG
...
## 🗑️ Remove files from the working tree and from the index
