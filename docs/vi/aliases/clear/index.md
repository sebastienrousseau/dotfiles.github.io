---
title: Bí Danh Clear | Dotfiles
description: Lệnh xóa màn hình rút gọn. Tổng quan cho Dotfiles v0.2.495. Tương thích với macOS, Linux và WSL qua Dotfiles.
lang: vi-VN
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: Bí Danh Clear | Dotfiles preview
canonical: /vi/aliases/clear/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Bí danh Clear
pageType: docs
schemaType: WebPage
permalink: /vi/aliases/clear/
---

# Bí Danh Clear

Lệnh xóa màn hình rút gọn.
