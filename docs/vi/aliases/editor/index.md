---
title: Bí Danh Editor | Dotfiles
description: Lệnh chỉnh sửa rút gọn. Tổng quan cho Dotfiles v0.2.495. Tương thích với macOS, Linux và WSL qua Dotfiles.
lang: vi-VN
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: Bí Danh Editor | Dotfiles preview
canonical: /vi/aliases/editor/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Bí danh Editor
pageType: docs
schemaType: WebPage
permalink: /vi/aliases/editor/
---

# Bí Danh Editor

Lệnh chỉnh sửa rút gọn.
