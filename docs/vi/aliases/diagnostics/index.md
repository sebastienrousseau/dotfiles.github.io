---
title: Bí Danh Diagnostics | Dotfiles
description: Lệnh kiểm tra sức khỏe rút gọn. Tổng quan cho Dotfiles v0.2.495. Tương thích với macOS, Linux và WSL qua Dotfiles.
lang: vi-VN
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: Bí Danh Diagnostics | Dotfiles preview
canonical: /vi/aliases/diagnostics/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Bí danh Diagnostics
pageType: docs
schemaType: WebPage
permalink: /vi/aliases/diagnostics/
---

# Bí Danh Diagnostics

Lệnh kiểm tra sức khỏe rút gọn.
