---
title: Bí Danh Rsync | Dotfiles
description: Lệnh đồng bộ rút gọn. Tổng quan cho Dotfiles v0.2.495. Tương thích với macOS, Linux và WSL qua Dotfiles.
lang: vi-VN
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: Bí Danh Rsync | Dotfiles preview
canonical: /vi/aliases/rsync/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Bí danh Rsync
pageType: docs
schemaType: WebPage
permalink: /vi/aliases/rsync/
---

# Bí Danh Rsync

Lệnh đồng bộ rút gọn.
