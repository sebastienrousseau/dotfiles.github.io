---
title: Bí Danh Fonts | Dotfiles
description: Lệnh cache phông chữ rút gọn. Tổng quan cho Dotfiles v0.2.495. Tương thích với macOS, Linux và WSL qua Dotfiles.
lang: vi-VN
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: Bí Danh Fonts | Dotfiles preview
canonical: /vi/aliases/fonts/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Bí danh Fonts
pageType: docs
schemaType: WebPage
permalink: /vi/aliases/fonts/
---

# Bí Danh Fonts

Lệnh cache phông chữ rút gọn.
