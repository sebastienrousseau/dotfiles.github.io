---
title: Bí Danh Modern | Dotfiles
description: Lệnh công cụ hiện đại rút gọn. Tổng quan cho Dotfiles v0.2.495. Tương thích với macOS, Linux và WSL qua Dotfiles.
lang: vi-VN
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: Bí Danh Modern | Dotfiles preview
canonical: /vi/aliases/modern/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Bí danh Modern
pageType: docs
schemaType: WebPage
permalink: /vi/aliases/modern/
---

# Bí Danh Modern

Lệnh công cụ hiện đại rút gọn.
