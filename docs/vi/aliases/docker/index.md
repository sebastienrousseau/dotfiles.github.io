---
title: Bí Danh Docker | Dotfiles
description: Tên lệnh Docker rút gọn. Tổng quan cho Dotfiles v0.2.495.
lang: vi-VN
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: Bí Danh Docker | Dotfiles preview
canonical: /vi/aliases/docker/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Bí danh Docker
pageType: docs
schemaType: WebPage
permalink: /vi/aliases/docker/
---

# Bí Danh Docker

Tên lệnh Docker rút gọn.
