---
title: Bí Danh PS | Dotfiles
description: Lệnh danh sách tiến trình rút gọn. Tổng quan cho Dotfiles v0.2.495. Tương thích với macOS, Linux và WSL qua Dotfiles.
lang: vi-VN
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: Bí Danh PS | Dotfiles preview
canonical: /vi/aliases/ps/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Bí danh PS
pageType: docs
schemaType: WebPage
permalink: /vi/aliases/ps/
---

# Bí Danh PS

Lệnh danh sách tiến trình rút gọn.
...
Không có ví dụ bí danh cho danh mục này.
