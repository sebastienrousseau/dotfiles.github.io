---
title: Bí Danh Permission | Dotfiles
description: Lệnh quyền và chủ sở hữu rút gọn. Tổng quan cho Dotfiles v0.2.495. Tương thích với macOS, Linux và WSL qua Dotfiles.
lang: vi-VN
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: Bí Danh Permission | Dotfiles preview
canonical: /vi/aliases/permission/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Bí danh Permission
pageType: docs
schemaType: WebPage
permalink: /vi/aliases/permission/
---

# Bí Danh Permission

Lệnh quyền và chủ sở hữu rút gọn.
