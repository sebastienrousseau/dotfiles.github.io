---
title: Aliasuri Actualizare | Dotfiles
description: Comenzi scurte pentru actualizare. Prezentare generală pentru Dotfiles v0.2.495. Compatibil cu macOS, Linux și WSL prin Dotfiles.
lang: ro-RO
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: Aliasuri Actualizare | Previzualizare Dotfiles
canonical: /ro/aliases/update/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Aliasuri Actualizare
pageType: docs
schemaType: WebPage
permalink: /ro/aliases/update/
---

# Aliasuri Actualizare

Comenzi scurte pentru actualizare.
...
Nu sunt disponibile exemple de aliasuri pentru această categorie.
