...
lastUpdated: true
image: /logo.png
imageAlt: Aliasuri Implicite | Previzualizare Dotfiles
canonical: /ro/aliases/default/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Aliasuri Implicite
pageType: docs
schemaType: WebPage
permalink: /ro/aliases/default/
---

# Aliasuri Implicite

Aliasuri shell zilnice principale.
...
- `history` → `'fc -il 1' # Afișează istoricul cu marcaje temporale ISO 8601 (zsh)`
- `ipinfo` → `ip -br addr`
- `ping` → `ping -c 5`
