---
title: Aliasuri Interactive | Dotfiles
description: Comenzi scurte pentru shell interactiv. Prezentare generală pentru Dotfiles v0.2.495. Compatibil cu macOS, Linux și WSL prin Dotfiles.
lang: ro-RO
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: Aliasuri Interactive | Previzualizare Dotfiles
canonical: /ro/aliases/interactive/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Aliasuri Interactive
pageType: docs
schemaType: WebPage
permalink: /ro/aliases/interactive/
---

# Aliasuri Interactive

Comenzi scurte pentru shell interactiv.
