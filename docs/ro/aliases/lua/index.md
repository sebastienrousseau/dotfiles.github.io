---
title: Aliasuri Lua | Dotfiles
description: Comenzi scurte pentru Lua. Prezentare generală pentru Dotfiles v0.2.495. Compatibil cu macOS, Linux și WSL prin Dotfiles.
lang: ro-RO
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: Aliasuri Lua | Previzualizare Dotfiles
canonical: /ro/aliases/lua/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Aliasuri Lua
pageType: docs
schemaType: WebPage
permalink: /ro/aliases/lua/
---

# Aliasuri Lua

Comenzi scurte pentru Lua.
