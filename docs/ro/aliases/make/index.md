---
title: Aliasuri Make | Dotfiles
description: Comenzi scurte pentru make. Prezentare generală pentru Dotfiles v0.2.495. Compatibil cu macOS, Linux și WSL prin Dotfiles.
lang: ro-RO
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: Aliasuri Make | Previzualizare Dotfiles
canonical: /ro/aliases/make/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Aliasuri Make
pageType: docs
schemaType: WebPage
permalink: /ro/aliases/make/
---

# Aliasuri Make

Comenzi scurte pentru make.
