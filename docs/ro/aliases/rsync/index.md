---
title: Aliasuri Rsync | Dotfiles
description: Comenzi scurte pentru sincronizare. Prezentare generală pentru Dotfiles v0.2.495. Compatibil cu macOS, Linux și WSL prin Dotfiles.
lang: ro-RO
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: Aliasuri Rsync | Previzualizare Dotfiles
canonical: /ro/aliases/rsync/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Aliasuri Rsync
pageType: docs
schemaType: WebPage
permalink: /ro/aliases/rsync/
---

# Aliasuri Rsync

Comenzi scurte pentru sincronizare.
