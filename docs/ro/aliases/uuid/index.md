---
title: Aliasuri UUID | Dotfiles
description: Comenzi scurte pentru UUID. Prezentare generală pentru Dotfiles v0.2.495. Compatibil cu macOS, Linux și WSL prin Dotfiles.
lang: ro-RO
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: Aliasuri UUID | Previzualizare Dotfiles
canonical: /ro/aliases/uuid/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Aliasuri UUID
pageType: docs
schemaType: WebPage
permalink: /ro/aliases/uuid/
---

# Aliasuri UUID

Comenzi scurte pentru UUID.
