---
title: Aliasuri PS | Dotfiles
description: Comenzi scurte pentru lista proceselor. Prezentare generală pentru Dotfiles v0.2.495. Compatibil cu macOS, Linux și WSL prin Dotfiles.
lang: ro-RO
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: Aliasuri PS | Previzualizare Dotfiles
canonical: /ro/aliases/ps/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Aliasuri PS
pageType: docs
schemaType: WebPage
permalink: /ro/aliases/ps/
---

# Aliasuri PS

Comenzi scurte pentru lista proceselor.
