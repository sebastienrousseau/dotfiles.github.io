---
title: Aliasuri Clear | Dotfiles
description: Comenzi scurte pentru curățarea ecranului. Prezentare generală pentru Dotfiles v0.2.495. Compatibil cu macOS, Linux și WSL prin Dotfiles.
lang: ro-RO
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: Aliasuri Clear | Previzualizare Dotfiles
canonical: /ro/aliases/clear/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Aliasuri Clear
pageType: docs
schemaType: WebPage
permalink: /ro/aliases/clear/
---

# Aliasuri Clear

Comenzi scurte pentru curățarea ecranului.
