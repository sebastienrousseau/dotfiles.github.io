---
title: Aliasuri Permisiuni | Dotfiles
description: Comenzi scurte pentru permisiuni și proprietar. Prezentare generală pentru Dotfiles v0.2.495. Compatibil cu macOS, Linux și WSL prin Dotfiles.
lang: ro-RO
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: Aliasuri Permisiuni | Previzualizare Dotfiles
canonical: /ro/aliases/permission/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Aliasuri Permisiuni
pageType: docs
schemaType: WebPage
permalink: /ro/aliases/permission/
---

# Aliasuri Permisiuni

Comenzi scurte pentru permisiuni și proprietar.
