---
title: Aliasuri Kubernetes | Dotfiles
description: Comenzi scurte pentru kubectl și Helm. Prezentare generală pentru Dotfiles v0.2.495. Compatibil cu macOS, Linux și WSL prin Dotfiles.
lang: ro-RO
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: Aliasuri Kubernetes | Previzualizare Dotfiles
canonical: /ro/aliases/kubernetes/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Aliasuri Kubernetes
pageType: docs
schemaType: WebPage
permalink: /ro/aliases/kubernetes/
---

# Aliasuri Kubernetes

Comenzi scurte pentru kubectl și Helm.
...
- `kaf` → `kubectl apply -f`
- `kctx` → `kubectx`
- `kctxc` → `'kubectx -c' # Contextul curent`
