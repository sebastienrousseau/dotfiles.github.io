---
title: Alias Interaktif | Dotfiles
...
lastUpdated: true
image: /logo.png
imageAlt: Alias Interaktif preview
canonical: /id/aliases/interactive/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Alias Interaktif
pageType: docs
schemaType: WebPage
metaTitle: Alias Interaktif - Dotfiles (ID)
permalink: /id/aliases/interactive/
meta:
  - name: keywords
