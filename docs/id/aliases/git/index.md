...
lastUpdated: true
image: /logo.png
imageAlt: "Alias Shell Git: Pintasan untuk Perintah Git Sehari-hari preview"
canonical: /id/aliases/git/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "Alias Shell Git: Pintasan untuk Perintah Git Sehari-hari"
pageType: docs
schemaType: WebPage
metaTitle: Alias Shell Git - Dotfiles (ID)
permalink: /id/aliases/git/
sidebar: true
meta:
  - name: keywords
