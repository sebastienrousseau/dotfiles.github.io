---
title: Alias Diagnostics | Dotfiles
...
lastUpdated: true
image: /logo.png
imageAlt: Alias Diagnostics preview
canonical: /id/aliases/diagnostics/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Alias Diagnostics
pageType: docs
schemaType: WebPage
metaTitle: Alias Diagnostics - Dotfiles (ID)
permalink: /id/aliases/diagnostics/
sidebar: true
meta:
  - name: keywords
