---
title: Alias GNU Core Utilities | Dotfiles
...
lastUpdated: true
image: /logo.png
imageAlt: Alias GNU Core Utilities preview
canonical: /id/aliases/gnu/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Alias GNU Core Utilities
pageType: docs
schemaType: WebPage
metaTitle: Alias GNU Core Utilities - Dotfiles (ID)
permalink: /id/aliases/gnu/
meta:
  - name: keywords
