---
title: Kubernetes-псевдонимы | Dotfiles
...
lastUpdated: true
image: /logo.png
imageAlt: Kubernetes-псевдонимы preview
canonical: /ru/aliases/kubernetes/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Kubernetes-псевдонимы
pageType: docs
schemaType: WebPage
metaTitle: Kubernetes-псевдонимы - Dotfiles (RU)
permalink: /ru/aliases/kubernetes/
sidebar: true
meta:
  - name: keywords
