...
description: Shell-алиасы для управления системой macOS, контроля Finder и задач обслуживания в Dotfiles. Совместимо с macOS, Linux и WSL через Dotfiles.
lang: ru-RU
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: "Алиасы macOS: shell-ярлыки для Mac preview"
canonical: /ru/aliases/macOS/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "Алиасы macOS: shell-ярлыки для Mac"
pageType: docs
schemaType: WebPage
metaTitle: Алиасы macOS | Dotfiles
permalink: /ru/aliases/macOS/
sidebar: true
meta:
  - name: keywords
