...
lastUpdated: true
image: /logo.png
imageAlt: "Алиасы Rust: ярлыки для разработки на Rust preview"
canonical: /ru/aliases/rust/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "Алиасы Rust: ярлыки для разработки на Rust"
pageType: docs
schemaType: WebPage
metaTitle: Алиасы Rust | Dotfiles
permalink: /ru/aliases/rust/
sidebar: true
meta:
  - name: keywords
