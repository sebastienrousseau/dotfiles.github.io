---
title: Google Cloud-псевдонимы | Dotfiles
...
lastUpdated: true
image: /logo.png
imageAlt: Google Cloud-псевдонимы preview
canonical: /ru/aliases/gcloud/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Google Cloud-псевдонимы
pageType: docs
schemaType: WebPage
metaTitle: Google Cloud-псевдонимы - Dotfiles (RU)
permalink: /ru/aliases/gcloud/
sidebar: true
meta:
  - name: keywords
