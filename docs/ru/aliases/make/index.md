...
description: Ярлыки-алиасы для команд Make. Упрощайте сборку, тесты и автоматизацию проектов. Совместимо с macOS, Linux и WSL через Dotfiles.
lang: ru-RU
author: Sebastien Rousseau
lastUpdated: true
image: /logo.png
imageAlt: "Алиасы Make: оптимизация рабочего процесса сборки preview"
canonical: /ru/aliases/make/
robots: index, follow
draft: false
noindex: false
sitemap: true
