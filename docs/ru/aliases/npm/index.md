...
lastUpdated: true
image: /logo.png
imageAlt: "Алиасы NPM: оптимизация управления пакетами Node preview"
canonical: /ru/aliases/npm/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "Алиасы NPM: оптимизация управления пакетами Node"
pageType: docs
schemaType: WebPage
metaTitle: Алиасы NPM | Dotfiles
permalink: /ru/aliases/npm/
sidebar: true
meta:
  - name: keywords
