...
lastUpdated: true
image: /logo.png
imageAlt: "Алиасы Modern Tooling: замены Unix на базе Rust preview"
canonical: /ru/aliases/modern/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "Алиасы Modern Tooling: замены Unix на базе Rust"
pageType: docs
schemaType: WebPage
metaTitle: Алиасы Modern Tooling | Dotfiles
permalink: /ru/aliases/modern/
sidebar: true
meta:
  - name: keywords
