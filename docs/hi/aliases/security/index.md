---
title: Security एलियास | Dotfiles
...
lastUpdated: true
image: /logo.png
imageAlt: Security एलियास preview
canonical: /hi/aliases/security/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Security एलियास
pageType: docs
schemaType: WebPage
metaTitle: Security एलियास - Dotfiles (HI)
permalink: /hi/aliases/security/
sidebar: true
meta:
  - name: keywords
