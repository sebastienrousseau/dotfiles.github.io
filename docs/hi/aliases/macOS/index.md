...
lastUpdated: true
image: /logo.png
imageAlt: "macOS एलियास: Mac के लिए शेल शॉर्टकट preview"
canonical: /hi/aliases/macOS/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "macOS एलियास: Mac के लिए शेल शॉर्टकट"
pageType: docs
schemaType: WebPage
metaTitle: macOS एलियास | Dotfiles
permalink: /hi/aliases/macOS/
sidebar: true
meta:
  - name: keywords
