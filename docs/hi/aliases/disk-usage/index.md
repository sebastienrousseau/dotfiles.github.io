...
lastUpdated: true
image: /logo.png
imageAlt: "Disk Usage एलियास: शेल कमांड से स्टोरेज मॉनिटर करें preview"
canonical: /hi/aliases/disk-usage/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "Disk Usage एलियास: शेल कमांड से स्टोरेज मॉनिटर करें"
pageType: docs
schemaType: WebPage
metaTitle: Disk Usage एलियास | Dotfiles
permalink: /hi/aliases/disk-usage/
sidebar: true
meta:
  - name: keywords
