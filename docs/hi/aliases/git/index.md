...
lastUpdated: true
image: /logo.png
imageAlt: "Git एलियास: अपने वर्जन कंट्रोल वर्कफ़्लो को सुव्यवस्थित करें preview"
canonical: /hi/aliases/git/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "Git एलियास: अपने वर्जन कंट्रोल वर्कफ़्लो को सुव्यवस्थित करें"
pageType: docs
schemaType: WebPage
metaTitle: Git एलियास | Dotfiles
permalink: /hi/aliases/git/
sidebar: true
meta:
  - name: keywords
