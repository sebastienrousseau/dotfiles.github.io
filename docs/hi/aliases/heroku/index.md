...
lastUpdated: true
image: /logo.png
imageAlt: "Heroku एलियास: Heroku CLI के लिए शेल शॉर्टकट preview"
canonical: /hi/aliases/heroku/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "Heroku एलियास: Heroku CLI के लिए शेल शॉर्टकट"
pageType: docs
schemaType: WebPage
metaTitle: Heroku एलियास | Dotfiles
permalink: /hi/aliases/heroku/
sidebar: true
meta:
  - name: keywords
