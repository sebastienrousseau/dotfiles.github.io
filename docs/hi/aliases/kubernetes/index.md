...
lastUpdated: true
image: /logo.png
imageAlt: "Kubernetes एलियास: अपने क्लस्टर मैनेजमेंट को सुव्यवस्थित करें preview"
canonical: /hi/aliases/kubernetes/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "Kubernetes एलियास: अपने क्लस्टर मैनेजमेंट को सुव्यवस्थित करें"
pageType: docs
schemaType: WebPage
metaTitle: Kubernetes एलियास | Dotfiles
permalink: /hi/aliases/kubernetes/
sidebar: true
meta:
  - name: keywords
