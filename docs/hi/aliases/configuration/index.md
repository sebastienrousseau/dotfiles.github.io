...
lastUpdated: true
image: /logo.png
imageAlt: "Configuration एलियास: कॉन्फ़िग फाइलों तक त्वरित पहुंच preview"
canonical: /hi/aliases/configuration/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "Configuration एलियास: कॉन्फ़िग फाइलों तक त्वरित पहुंच"
pageType: docs
schemaType: WebPage
metaTitle: Configuration एलियास | Dotfiles
permalink: /hi/aliases/configuration/
sidebar: true
meta:
  - name: keywords
