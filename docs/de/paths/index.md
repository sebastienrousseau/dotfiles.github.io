...
lastUpdated: true
image: /logo.png
imageAlt: Pfade (Paths) preview
canonical: /de/paths/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: Pfade (Paths)
pageType: docs
schemaType: WebPage
...
4.  **Homebrew** (`/opt/homebrew/bin`)
    ...
    - **Hinweis**: Wir laden Homebrew absichtlich _vor_ den Systempfaden, um das Upgrade von Systemwerkzeugen (wie `git` oder `curl`) zu ermöglichen.
