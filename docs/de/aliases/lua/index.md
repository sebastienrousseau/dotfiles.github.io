...
lastUpdated: true
image: /logo.png
imageAlt: "Lua Aliase: Schneller Zugriff auf Lua REPL Interpreter preview"
canonical: /de/aliases/lua/
robots: index, follow
draft: false
noindex: false
sitemap: true
breadcrumbTitle: "Lua Aliase: Schneller Zugriff auf Lua REPL Interpreter"
pageType: docs
schemaType: WebPage
