...
lang: de-DE
metaTitle: Chmod aliases - Dotfiles (DE)
...
meta:
  ...
  - name: twitter:description
    content: The Chmod aliases allow to change the permissions (or access mode) of a file or directory.
  - name: twitter:title
    content: Chmod aliases - Dotfiles (DE)
  - name: og:title
    content: Chmod aliases - Dotfiles (DE)
  - name: og:description
    content: The Chmod aliases allow to change the permissions (or access mode) of a file or directory.
...
| chgrp  | `chgrp -v`          | Change group ownership of Dateien or directories.                                                                                                                                                                      |
| chgrpr | `chgrp -Rv`         | Change group ownership of Dateien or directories recursively.                                                                                                                                                          |
| chgrpu | `chgrp -Rv ${USER}` | Change group ownership of Dateien or directories recursively to the current user.                                                                                                                                      |
| chmod  | `chmod -v`          | Change Datei mode bits.                                                                                                                                                                                               |
| chmodr | `chmod -Rv`         | Change Datei mode bits recursively.                                                                                                                                                                                   |
| chmodu | `chmod -Rv u+rwX`   | Change Datei mode bits recursively to the current user.                                                                                                                                                               |
| chmox  | `chmod +x`          | Make a Datei executable.                                                                                                                                                                                              |
| chown  | `chown -v`          | Change Datei owner and group.                                                                                                                                                                                         |
| chownr | `chown -Rv`         | Change Datei owner and group recursively.                                                                                                                                                                             |
| chownu | `chown -Rv ${USER}` | Change Datei owner and group recursively to the current user.                                                                                                                                                         |
